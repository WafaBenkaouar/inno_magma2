...
public class ButtonGridView extends View implements SimonClone.Listener {
	...
	private void initDrawingInstruments() {
		...
		redOnBitmap = BitmapFactory.decodeResource(resources, R.drawable.ex_red_off);
		...
		blueOnBitmap = BitmapFactory.decodeResource(resources, R.drawable.ex_blue_off);
		...
		greenOnBitmap = BitmapFactory.decodeResource(resources, R.drawable.ex_green_off);
		...
		yellowOnBitmap = BitmapFactory.decodeResource(resources, R.drawable.ex_yellow_off);
	}	
